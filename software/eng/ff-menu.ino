...
int alMin;
  ...
  displayPrintLn("SET FEED " + String(AlarmNum) + "      ", 0, 0);
...
void menuRetractionSet() {
  ...
  if (RetractionState == 1) {
    displayPrintLn("RETRACT: YES    ", 0, 0);
  } else {
    displayPrintLn("RETRACT: NO     ", 0, 0);
  }
